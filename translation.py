...
Original file is located at
    https://colab.research.google.com/drive/1KrX7jZ5PdkLXWl9xqn833JXy2f1ayH2C
"""
...
# ✅ STEP 3: Upload files
print("📁 Upload your ORIGINAL file (e.g. winoqueer_final.csv)")
uploaded = files.upload()

print("📁 Now upload your PARTIALLY TRANSLATED file (e.g. winoqueer_final_translated_progress.csv)")
uploaded = files.upload()
# ✅ STEP 4: Load data
